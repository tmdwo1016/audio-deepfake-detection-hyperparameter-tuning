...
Track label은 REAL 296, FAKE 3,162이며, segment label은 REAL 888, FAKE 9,189입니다. 따라서 Accuracy 단독 대신 ROC-AUC, PR-AUC, EER, Balanced Accuracy, Macro-F1, REAL FPR, FAKE miss rate를 사용했습니다.
...
![In-domain model comparison](../results/final_analysis/figures/01_in_domain_track_performance.png)
...
- MERT에 대한 unseen-generator 및 codec robustness 실험은 현재 범위에 포함되지 않았습니다.
...
2. MERT의 unseen-generator 및 codec robustness 측정
...
- Codec robustness: `results/mp3_robustness/`, `results/cnn_mp3_robustness/`
